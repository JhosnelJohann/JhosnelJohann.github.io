...
export const trabajo: Pieza[] = [
  {
    ...
    detalle: [
      ...
      'Sobre PostgreSQL de 85 tablas: 31 622 contactos reales, 7 491 oportunidades, 39 032 tareas y 196 818 archivos indexados. Videollamadas propias con LiveKit, sincronización de correo y gestión documental sobre Cloudflare R2.',
  ...
  {
    id: 'landings-cerradas',
    titulo: 'Medicare y ManhattanLife',
    categoria: 'Landing de captación',
    restringido: 'Tras autenticación · campañas cerradas',
    motivo: 'landings',
    color: 'amarillo',
    año: '2026',
    gancho:
      'Dos aplicaciones de captación de seguros de salud, hoy tras contraseña por decisión comercial de la empresa.',
    detalle: [
      ...
      'La validación de código postal tiene tres estados, no dos: válido, inexistente y no verificable. En el tercero deja pasar al usuario. Si el geocodificador se cae, el formulario no bloquea — la alternativa cómoda habría perdido leads en silencio.',
      'El avatar del cuestionario es un componente SVG escrito a mano de unos 7 KB, donde cada pieza es un nodo animable, sin peticiones externas.',
    ],
    cifras: [
